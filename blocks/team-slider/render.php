<?php
/**
 * Team-Slider: Container für bw/team-member-Kinder.
 *
 * @var array  $attributes
 * @var string $content Bereits gerenderte InnerBlocks (team-member).
 */
...
?>
<div <?php echo get_block_wrapper_attributes( array( 'class' => 'bw-block bw-team-slider' ) ); ?><?php echo bodywings_block_bg_attr( $attributes ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	<div class="bw-block__inner">
		<?php if ( $bw_heading ) : ?>
			<h2 class="bw-team-slider__heading"><?php echo wp_kses_post( $bw_heading ); ?></h2>
		<?php endif; ?>

		<div class="bw-slider" data-bw-slider>
			<ul class="bw-slider__track bw-team-slider__track" data-bw-slider-track tabindex="0" role="region" aria-label="<?php esc_attr_e( 'Team, horizontal scrollbar', 'bodywings' ); ?>">
